...
class LoanedBookInstanceSByUserListViewTest(TestCase):
	...
	def setUp(self):
		...
		#Create a book
		test_author = Author.objects.create(first_name='john', last_name='Simith')
	...
	def test_only_borrowed_books_in_list(self):
		...
		#Check that initially we do not have any books in list(none on loan)
...
class RenewBookInstancesViewTest(TestCase):
	...
	def test_form_invalid_renewal_date_future(self):
		...
		self.assertEqual( resp.status_code,200)
		self.assertFormError(resp, 'form', 'renewal_date', 'Invalid date - renewal more than 4 weeks')
...
class AuthorCreateViewTest(TestCase):
	...
	def test_form_renewal_date_initially_has_date_three_weeks_in_future(self):
		...
		initialDateForBookCreate = "12/10/2016"
		self.assertEqual(resp.context['form'].initial['date_of_death'], initialDateForBookCreate )

	def test_redirects_to_all_book_list_on_success(self):
		login = self.client.login(username='testuser2', password='12345')
		initialDateForBookCreate = "12/10/2016"
		resp = self.client.post(reverse('author-create'), {'first_name':'Asha', 'last_name':'Lv', 'date_of_birth':"12/10/1990", 'date_of_death':initialDateForBookCreate,} )
		self.assertEqual( resp.status_code,302)
